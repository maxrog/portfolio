...
* **Core Location**: Display distance/overlay on the map and retrieve the starting location coordinates for our API calls in the trip planner.   
...
**Moving Forward**: Enhanced Trip Planner, Maintenance
{% endtextalign %}
