...
* At random intervals on the score clock, based on their opponents defensive stats they have a chance to randomly select a position in the matrix leading to a possible score. 
{% endtextalign %} 
{% textalign left %}
**Takeaways** 
