...
name: "Racine Zoo"
tagline: "The perfect companion for a trip to the zoo"
...
**Takeaways**  
* Override **drawRect** to create custom views. If two events fall on the same day, the cell would expand to include both of them next to one date view.  
